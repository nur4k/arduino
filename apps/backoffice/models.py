...
class Driver(models.Model):
    ...
    car_number = models.CharField(
        verbose_name="Номер машины", max_length=20, null=True, blank=True
    )
    ...
    def save(  # type: ignore
        self, force_insert=False, force_update=False, using=None, update_fields=None  # type: ignore
    ) -> None:
...
class GIS(models.Model):
    ...
    )  # Связь OneToOne с моделью Location
